    ...
    <>
     ...
     <div className="bg-gray-900 min-h-screen flex items-center text-white">
      ...
      <div className="max-w-4xl mx-auto p-6">
        <h1 className="text-4xl font-bold text-gray-900 mb-4 text-left" id="achievements">The Purpose</h1>
      ...
      {/* Idea Section */}
      <div className="max-w-4xl mx-auto p-6">
        <h1 className="text-4xl font-bold text-gray-900 mb-4 text-left">The Idea</h1>
        <p className="text-gray-700 text-lg leading-relaxed text-left border-gray-300">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center bg-gray-100 p-4 md:p-10">
    <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-6 md:gap-10 p-4 md:p-5">
        {/* Image Section - Image will be on the left for larger screens */}
        <div className="flex-1 flex justify-center md:justify-start">
            <Image
                src={mothership} // Update with the correct path to your image
                alt="The Mothership Image"
                width={450}  // Adjust based on your design needs
                height={400} // Adjust based on your design needs
                className="shadow-lg rounded-lg max-w-full h-auto" // Responsive image handling
            />
        </div>

        {/* Text Section */}
        <div className="flex-1 flex flex-col p-4 md:p-5 items-start">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">The Mothership</h1>
...
<div className="flex flex-col-reverse md:flex-row items-center justify-center bg-gray-100 p-4 md:p-10">
  <div className="container mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-6 md:gap-10 p-4 md:p-5">
    
    {/* Text Section */}
    <div className="flex-1 p-5">
      <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">The Daughter Drone</h1>
      <p className="text-gray-600 text-base md:text-lg leading-relaxed">
        The daughter drone, a 25 kg autonomous coaxial-octocopter capable of launching in mid-air, is meant to replace the
        communication module. It is equipped with a Pixhawk 4 for controlling the drone during flight. Intel Realsense D435 
        for obtaining live video feed of the surroundings, Intel NUC 5i5RYH onboard computation, Here3 GPS for localisation, 
        and 7 DOF robotic arm for gripping the mast and replacing the module.
      </p>
    </div>
    ...
    <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-6 md:gap-10 p-4 md:p-5">
        <div className="flex-1 flex justify-center">
            <Image
                ...
                alt="ICUAS 2023 Image"
                width={450}  // Adjust based on your design needs
                height={400} // Adjust based on your design needs
                className="shadow-lg rounded-lg max-w-full h-auto" // Responsive image
            />
        </div>
        <div className="flex-1 flex flex-col p-4 md:p-5 items-start">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">ICUAS&apos;23</h1>
            <p className="text-gray-600 text-base md:text-lg leading-relaxed">
                The competition&apos;s challenge involved a UAV tasked with manoeuvring through an unknown 3D GPS-denied environment, determining its position, and navigating around obstacles. Upon reaching points of interest, the UAV was required to scan the area and detect any defects in the infrastructure. World Champions in the simulation stage and 2nd Runner Ups in live trials held in Warsaw, Poland. Developed an agile, collision-free navigation strategy to navigate through an industrial environment. Incorporated dynamic obstacle inflation, waypoint perturbation into the existing EGO Planner framework.
            </p>
        </div>
    </div>
</div>

<div className="flex flex-col md:flex-row-reverse items-center justify-center bg-gray-100 p-4 md:p-10">
    <div className="container mx-auto flex flex-col md:flex-row-reverse items-center justify-between gap-6 md:gap-10 px-4 md:px-5">
        <div className="flex-1 flex justify-center">
            <Image
        ...
        <div className="flex-1 p-4 md:p-5">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">UAS&apos;23</h1>
            <p className="text-gray-600 text-base md:text-lg leading-relaxed">
...
<div className="flex flex-col md:flex-row items-center justify-center bg-gray-100 p-4 md:p-10">
    <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-6 md:gap-10 p-4 md:p-5">
        ...
        <div className="flex-1 flex flex-col p-4 md:p-5 items-start">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">RI4 Rover</h1>
            <p className="text-gray-600 text-base md:text-lg leading-relaxed">
...
<div className="flex flex-col-reverse md:flex-row items-center justify-center bg-gray-100 p-4 md:p-10">
    <div className="container mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-6 md:gap-10 px-4 md:px-5">
        
        {/* Text Section */}
        <div className="flex-1 p-4 md:p-5">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Robodrive ICRA&apos;24</h1>
            <p className="text-gray-600 text-base md:text-lg leading-relaxed">
...
<div className="flex flex-col md:flex-row items-center justify-center bg-gray-100 p-4 md:p-10">
    <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-6 md:gap-10 p-4 md:p-5">
        ...
        {/* Text Section */}
        <div className="flex-1 flex flex-col p-4 md:p-5 items-start">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">C-UASC&apos;24</h1>
            <p className="text-gray-600 text-base md:text-lg leading-relaxed">
...
<div className="sm:flex sm:items-center sm:justify-between pb-10 px-10">
  <div className="flex flex-col items-center sm:flex-row sm:items-center">
    <Image
      ...
      height={400} // Adjust based on your design needs
    />
    <span className="flex self-center sm:self-auto px-4 text-4xl font-bold text-[#111827]">AeRoVe</span>
  </div>

  <div className="text-center sm:text-right sm:ml-10">
    <div className="p-5">
      <p>Aayushi: 7391985746</p>
      <p>Pranav: 9356865627</p>
      <p>Nitya: 6238884779</p>
    </div>
    <div className="flex justify-center sm:justify-end scale-[1.3] px-10">
      <div className="flex gap-5">
        <a href="https://github.com/Innovation-Cell" className="text-gray-500">
        ...
        <a href="https://www.instagram.com/umic_iitb/" className="text-gray-500">
        ...
        <a href="https://www.linkedin.com/company/unmesh-mashruwala-innovation-cell-iit-bombay/" className="text-gray-500">
          <svg className="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
